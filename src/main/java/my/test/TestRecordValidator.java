...
public class TestRecordValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		System.out.println("Entity passed " + passedRecord.toString());
